...
public class SongDetailListAdapter extends RecyclerView.Adapter<SongDetailListAdapter.ViewHolder> {
    ...
    private static final String TAG = SongDetailListAdapter.class.getSimpleName();
    ...
    @NonNull
    @Override
    public SongDetailListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.item_song_list, parent, false);
